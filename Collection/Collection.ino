  ...
  while (LoraSerial.available())
  {
    ...
    else
    {
      if (data.indexOf("water") != -1)
      {
        ...
        if (water_value.indexOf("ON") != -1)
          digitalWrite(water_pump_switch, HIGH);
        else if (water_value.indexOf("OFF") != -1)
      ...
      else if (data.indexOf("oxygen") != -1)
      {
        ...
        if (oxygen_value.indexOf("ON") != -1)
          digitalWrite(oxygen_pump_switch, HIGH);
        else if (oxygen_value.indexOf("OFF") != -1)
          digitalWrite(oxygen_pump_switch, LOW);
        LoraSerial.println("ACK");
        Serial.println("ACK");
      }
    }
